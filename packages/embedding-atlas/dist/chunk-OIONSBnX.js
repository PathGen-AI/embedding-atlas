...
var Di = Array.isArray, Ra = Array.prototype.indexOf, Rn = Array.from, Ui = Object.defineProperty, Jt = Object.getOwnPropertyDescriptor, ki = Object.getOwnPropertyDescriptors, Ta = Object.prototype, Ma = Array.prototype, Tn = Object.getPrototypeOf, Zn = Object.isExtensible;
function Fa(e) {
  ...
  #i(t, r) {
    ...
    for (var n = t.first; n !== null; ) {
      ...
      if ((n.f & $r) !== 0 && n.b?.is_pending() && (r = {
        ...
        a ? n.f ^= xe : (i & Or) !== 0 ? r.effects.push(n) : Rr(n) && ((n.f & dt) !== 0 && r.block_effects.push(n), br(n));
        var u = n.first;
        if (u !== null) {
          n = u;
          continue;
...
function Kn(e) {
  ...
  if (t !== 0) {
    for (var r = 0; r < t; ) {
      var n = e[r++];
      if ((n.f & (wt | Ie)) === 0 && Rr(n) && (st = /* @__PURE__ */ new Set(), br(n), n.deps === null && n.first === null && n.nodes_start === null && (n.teardown === null && n.ac === null ? bo(n) : n.fn = null), st?.size > 0)) {
        Et.clear();
        for (const i of st) {
...
class il {
  ...
  #g() {
    ...
    this.#a !== null && (this.#s = document.createDocumentFragment(), this.#s.append(
      /** @type {TemplateNode} */
      this.#f
    ), Eo(this.#a, this.#s)), this.#i === null && (this.#i = ze(() => t(this.#e)));
  }
  /**
  ...
  error(t) {
    ...
    if (this.#p || !r && !n)
      throw t;
    this.#a && (Re(this.#a), this.#a = null), this.#i && (Re(this.#i), this.#i = null), this.#o && (Re(this.#o), this.#o = null), X && (Be(
      /** @type {TemplateNode} */
      this.#r
    ), Xi(), Be(Ur()));
    var i = !1, a = !1;
...
function co(e) {
  var t = Ee, r = Ue, n = Oe, i = z, a = ct, o = Pe, l = Ze, u = Nt, s = e.f;
  Ee = /** @type {null | Value[]} */
  ...
  try {
    ...
    if (Ee !== null) {
      ...
      if (Nr(e, Ue), p !== null && Ue > 0)
        for (p.length = Ue + Ee.length, h = 0; h < Ee.length; h++)
          p[Ue + h] = Ee[h];
      else
        e.deps = p = Ee;
      if (kt && jr() && (e.f & Ve) !== 0)
    ...
    e.f ^= hn, Ee = t, Ue = r, Oe = n, z = i, ct = a, nr(o), Ze = l, Nt = u;
  }
}
function cl(e, t) {
  let r = t.reactions;
  ...
  (Ee === null || !Ee.includes(t)) && (_e(t, vt), (t.f & Ve) !== 0 && (t.f ^= Ve, t.f &= ~xr), ro(
    /** @type {Derived} **/
    t
  ), Nr(
    /** @type {Derived} **/
...
function c(e) {
  ...
  if (z !== null && !Ze) {
    ...
    if (!n && !ct?.includes(e)) {
      var i = z.deps;
      if ((z.f & hn) !== 0)
        e.rv < _r && (e.rv = _r, Ee === null && i !== null && i[Ue] === e ? Ue++ : Ee === null ? Ee = [e] : Ee.includes(e) || Ee.push(e));
      else {
        (z.deps ??= []).push(e);
        var a = e.reactions;
  ...
  if ($t) {
    ...
    if (r) {
      ...
      return ((o.f & xe) === 0 && o.reactions !== null || po(o)) && (l = Bn(o)), Et.set(o, l), l;
    }
  } else if (r) {
    if (o = /** @type {Derived} */
    e, ke?.has(o))
      return ke.get(o);
    Rr(o) && no(o), kt && jr() && (o.f & Ve) === 0 && ho(o);
  } else if (ke?.has(e))
    return ke.get(e);
  if ((e.f & At) !== 0)
    throw e.v;
...
function _o(e, t = !1) {
  ...
  for (e.first = e.last = null; r !== null; ) {
    ...
    var n = r.next;
    (r.f & qt) !== 0 ? r.parent = null : Re(r, t), r = n;
  }
}
function yl(e) {
...
const Ro = /* @__PURE__ */ new Set(), yn = /* @__PURE__ */ new Set();
function xl(e, t, r, n = {}) {
  function i(a) {
...
function ue(e, t) {
  if (X) {
    ...
    ((r.f & zr) === 0 || r.nodes_end === null) && (r.nodes_end = G), Er();
    return;
  }
  e !== null && e.before(
    /** @type {Node} */
...
class Ml {
  ...
  constructor(t) {
    ...
    this.#e = (t.hydrate ? Rl : Mo)(t.component, {
      target: t.target,
      anchor: t.anchor,
      props: i,
      context: t.context,
...
class Bo {
      ...
      for (const [a, o] of this.#e) {
        ...
        const l = () => {
          if (Array.from(this.#t.values()).includes(a)) {
            ...
            Eo(o, u), u.append(et()), this.#r.set(a, { effect: o, fragment: u });
          } else
            Re(o);
          this.#e.delete(a);
        };
  ...
  #l = (t) => {
    ...
    for (const [n, i] of this.#r)
      r.includes(n) || (Re(i.effect), this.#r.delete(n));
  };
  /**
   *
   * @param {any} key
...
function Cl(e, t, r) {
  ...
  wo(i, () => {
    for (var s = 0; s < a; s++) {
      var f = t[s];
      l || (n.delete(f.k), We(e, f.prev, f.next)), Re(f.e, !l);
    }
  });
}
...
function Pl(e, t, r, n, i, a, o, l, u) {
  var s = (o & $a) !== 0, f = (o & (Mn | Fn)) !== 0, d = t.length, p = r.items, h = r.first, v = h, g, y = null, b, w = [], x = [], F, E, R, B;
  if (s)
    for (B = 0; B < d; B += 1)
      F = t[B], E = l(F, B), R = p.get(E), R !== void 0 && (R.a?.measure(), (b ??= /* @__PURE__ */ new Set()).add(R));
  for (B = 0; B < d; B += 1) {
    if (F = t[B], E = l(F, B), R = p.get(E), R === void 0) {
      var N = n.get(E);
      if (N !== void 0) {
        n.delete(E), p.set(E, N);
        var Z = y ? y.next : v;
    ...
    if (f && Dl(R, F, B, o), (R.e.f & Ie) !== 0 && (Un(R.e), s && (R.a?.unfix(), (b ??= /* @__PURE__ */ new Set()).delete(R))), R !== v) {
      if (g !== void 0 && g.has(R)) {
        if (w.length < x.length) {
          ...
          g.delete(R), on(R, v, i), We(r, R.prev, R.next), We(r, R, y === null ? r.first : y.next), We(r, y, R), y = R;
        continue;
      }
      for (w = [], x = []; v !== null && v.k !== E; )
        (v.e.f & Ie) === 0 && (g ??= /* @__PURE__ */ new Set()).add(v), x.push(v), v = v.next;
      if (v === null)
        continue;
      R = v;
    }
    w.push(R), y = R, v = R.next;
  }
  if (v !== null || g !== void 0) {
    for (var ve = g === void 0 ? [] : Rn(g); v !== null; )
...
function $l(e, t) {
  ...
  function a(y) {
    return (b) => {
      ...
      return {
        move: (x) => {
          let F = x.pageX - b.pageX, E = x.pageY - b.pageY, R = [F, E, F, E].map((Z, te) => w[te] + Z * y[te]), B = t.coordinateAtPoint(R[0], R[1]), N = t.coordinateAtPoint(R[2], R[3]);
          t.onChange({
  ...
  M(g, "width", i), M(g, "height", i), $(g, "", {}, {
    ...
    (y, b, w, x, F, E, R, B, N, Z, te, j) => {
      M(l, "x", y), M(l, "width", b), M(l, "y", w), M(l, "height", x), M(u, "x", c(r).x - i / 2), M(u, "y", F), M(u, "height", E), M(s, "x", c(n).x - i / 2), M(s, "y", R), M(s, "height", B), M(f, "x", N), M(f, "width", Z), M(f, "y", c(r).y - i / 2), M(d, "x", te), M(d, "width", j), M(d, "y", c(n).y - i / 2), M(p, "x", c(r).x - i / 2), M(p, "y", c(r).y - i / 2), M(h, "x", c(r).x - i / 2), M(h, "y", c(n).y - i / 2), M(v, "x", c(n).x - i / 2), M(v, "y", c(r).y - i / 2), M(g, "x", c(n).x - i / 2), M(g, "y", c(n).y - i / 2);
    },
    [
...
function iu(e, t) {
  ...
  var p = pe(f);
  {
    var h = (x) => {
      var F = ru(), E = Ht(F);
      $(E, "", {}, { color: "currentColor", "text-decoration": "underline" });
      var R = pe(E, !0);
      fe(E), Xi(2), Ne(() => {
        M(E, "href", t.resolvedTheme.brandingLink.href), mr(R, t.resolvedTheme.brandingLink.text);
      }), ue(x, F);
    };
    Me(p, (x) => {
  ...
  kn(() => {
    yr(() => {
      ...
      return yr(() => {
        ...
        function d(y, b, w, x) {
          let F = t.location.x, E = t.location.y, R = 2, B = y / 2, N = b + (t.targetHeight + r());
          F - B < w && (B = F - w), F - B > x - y && (B = F - x + y), E - N < R && (N = -(t.targetHeight + r())), i.style.left = F - B + "px", i.style.top = E - N + "px";
        }
...
function Iu(e, t, r) {
  ...
  return e.derive([t, o, a], (l, u, s) => (f, d, p) => {
    ...
    for (let w = 0; w < 2; w++) {
      ...
      for (let [x, F, E] of Lu) {
        l.bindFramebuffer(l.FRAMEBUFFER, y.framebuffer), l.bindTexture(l.TEXTURE_2D, g), l.uniform1fv(s.uniforms.weight0, F), l.uniform3fv(s.uniforms.distances, x), l.uniform3fv(s.uniforms.weights, E), l.drawArrays(l.TRIANGLE_STRIP, 0, 4), g = y.texture;
        let R = y;
        y = b, b = R;
      }
    }
...
function Hu(e, t, r, n) {
  ...
  return e.derive(
    ...
    (u, s, f, d, p, h, v) => (g) => {
      ...
      for (let w = 0; w < v; w++)
        if (w < b.length) {
          let { r: x, g: F, b: E } = Ln(b[w]);
          x = Math.pow(x, g.gamma), F = Math.pow(F, g.gamma), E = Math.pow(E, g.gamma), y = y.concat([x, F, E, 1]);
        } else
...
function Qu(e, t, r, n) {
  ...
  return e.derive(
    ...
    (x, F, E, R, B, N, Z, te, j, Q, we, K, ve, ie) => (q) => {
      ...
      let W = q.width / E.width, Ae = q.height / E.height, de = On([W, 0, 0, 0, Ae, 0, 0, 0, 1], Z);
      if (x.bindFramebuffer(x.FRAMEBUFFER, F.framebuffer), x.viewport(0, 0, F.width, F.height), x.clearColor(0, 0, 0, 0), x.clear(x.COLOR_BUFFER_BIT), te(de), x.bindFramebuffer(x.FRAMEBUFFER, E.framebuffer), x.viewport(0, 0, E.width, E.height), N == "light" ? x.clearColor(1, 1, 1, 1) : x.clearColor(0, 0, 0, 1), x.clear(x.COLOR_BUFFER_BIT), q.pointAlpha > 0 && q.pointsAlpha > 0 && (j(F.texture, R, B), x.bindFramebuffer(x.FRAMEBUFFER, E.framebuffer), we(R, q.pointAlpha, q.pointsAlpha, ae, N)), q.densityScaler > 0 && (q.densityAlpha > 0 || q.contoursAlpha > 0) && (Q(F.texture, R, B), x.bindFramebuffer(x.FRAMEBUFFER, E.framebuffer), q.densityAlpha > 0 && K(
        R,
        q.densityScaler,
      ...
      x.bindFramebuffer(x.FRAMEBUFFER, null), x.viewport(0, 0, q.width, q.height), ie(E.texture, q.gamma, 1 / W, 1 / Ae);
    }
  );
}
function Zu(e, t, r, n, i, a) {
  ...
  return e.derive(
    ...
    (v, g, y, b, w, x, F, E, R) => (B) => {
      ...
      v.bindFramebuffer(v.FRAMEBUFFER, w.framebuffer), v.viewport(0, 0, w.width, w.height), v.clearColor(0, 0, 0, 0), v.clear(v.COLOR_BUFFER_BIT), E(te), R(w.texture, x, F), v.bindFramebuffer(v.FRAMEBUFFER, x.framebuffer);
...
function ss(e, t, r, n, i, a, o) {
  let l = e.derive([a.densityBandwidth], (E) => Math.ceil(E * 3) + 1), u = e.derive([a.width, l], (E, R) => E + R * 2), s = e.derive([a.height, l], (E, R) => E + R * 2), f = e.derive([u], (E) => Math.ceil(E / 4)), d = e.derive([s], (E) => Math.ceil(E / 4)), p = Wo(
    e,
    t,
    u,
    s,
    ...
    (E, R) => (E == null && (E = Hr(R)), E.map((B) => Ln(B)))
  );
  return e.derive(
    [
      t,
    ...
    (E, R, B, N, Z, te, j, Q, we, K, ve, ie, q, oe, ae) => (W, Ae) => {
      let de = W.colorScheme == "light" ? [1, 1, 1, 1] : [0, 0, 0, 1], le = W.width / R, ge = W.height / B, Le = On([le, 0, 0, 0, ge, 0, 0, 0, 1], Q);
      te({
        count: j,
      ...
      let ye = E.createCommandEncoder();
      K(ye), W.mode == "density" && (W.densityAlpha > 0 || W.contoursAlpha > 0) && (ie(ye), q(ye), oe(ye)), ve(ye, Ae), E.queue.submit([ye.finish()]);
    }
  );
}
function fs(e, t, r, n, i, a, o, l, u) {
  ...
  return e.derive(
    ...
    (h, v, g, y, b, w, x, F, E, R) => () => {
      ...
      return B.copyBufferToBuffer(R, 0, Z, 0, v * g * 2), h.queue.submit([B.finish()]), Z.mapAsync(GPUMapMode.READ, 0, v * g * 2).then(() => cs(Z.getMappedRange()));
    }
  );
}
function cs(e) {
...
function Rs(e, t) {
  const r = Es(e, 5), n = Po(r);
  let i = Math.max(n.xMax - n.xMin, n.yMax - n.yMin) / 100, a = Ei(r, i), o = 0;
  for (; a.length > t && o < 20; )
    i *= 1.1, o += 1, a = Ei(r, i);
  return a;
}
...
function Ts(e, t) {
  return e == null ? Ri[t] : { ...Ri[t], ...e, ...e[t] != null ? e[t] : {} };
}
...
function Ho(e, t) {
        ...
        return {
          move: (D) => {
            if (de(null), c(I) == null)
              return;
            let O = Xt(D);
            P = [...P, c(q)(O.x, O.y)], P.length >= 3 && ge(Rs(P, 24));
          }
        };
      }
      case "pan": {
  ...
  {
    var ca = (_) => {
      const A = /* @__PURE__ */ U(() => Do(E())), S = /* @__PURE__ */ U(() => ({
        location: c(ie),
        width: a(),
        height: o()
      }));
      ...
      Bl(D, () => c(A), (O) => {
        var V = Fs();
        $e(V, (H, ee) => c(A)?.(H, ee), () => Uo(E(), { proxy: c(S) })), ue(O, V);
      }), ue(_, P);
    };
    Me(fa, (_) => {
      E() && _(ca);
...
function Os(e, t) {
  ...
  }
  {
    ...
    Ho(e, {
      ...
      get maxDensity() {
        return c(R).maxDensity;
      },
      get categoryCount() {
        return c(R).categoryCount;
      },
      get categoryColors() {
        return a();
      },
      get defaultViewportState() {
        return c(R).defaultViewportState;
      },
      get querySelection() {
        return g();
      },
...
function Vs(e, t) {
  Tt(t, !0);
  let r = T(t, "coordinator", 19, _a), n = T(t, "category", 3, null), i = T(t, "text", 3, null), a = T(t, "identifier", 3, null), o = T(t, "filter", 3, null), l = T(t, "categoryColors", 3, null), u = T(t, "tooltip", 3, null), s = T(t, "additionalFields", 3, null), f = T(t, "selection", 3, null), d = T(t, "rangeSelection", 3, null), p = T(t, "rangeSelectionValue", 3, null), h = T(t, "width", 3, null), v = T(t, "height", 3, null), g = T(t, "pixelRatio", 3, null), y = T(t, "config", 3, null), b = T(t, "theme", 3, null), w = T(t, "viewportState", 3, null), x = T(t, "labels", 3, null), F = T(t, "customTooltip", 3, null), E = T(t, "customOverlay", 3, null), R = T(t, "onViewportState", 3, null), B = T(t, "onTooltip", 3, null), N = T(t, "onSelection", 3, null), Z = T(t, "onRangeSelection", 3, null), te = T(t, "cache", 3, null), j = /* @__PURE__ */ J(new Float32Array()), Q = /* @__PURE__ */ J(new Float32Array()), we = /* @__PURE__ */ J(null), K = /* @__PURE__ */ J(1), ve = /* @__PURE__ */ J(1), ie = /* @__PURE__ */ J(1), q = /* @__PURE__ */ J(null), oe = /* @__PURE__ */ J(null), ae = /* @__PURE__ */ J(null), W = /* @__PURE__ */ J(null), Ae = /* @__PURE__ */ J(null);
  ut(() => {
    let C = {
      coordinator: r(),
      source: {
